                ...
                <a href="fixed-index.html" class="sidebar-brand">
                    ...
                    <span class="avatar avatar-xl sidebar-brand-icon h-auto">
                        <span class="avatar-title rounded bg-primary"><img
                                src="assets/images/illustration/student/128/white.svg" class="img-fluid"
                                alt="logo" /></span>
                    </span>
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="sidebar-menu-item">
                        ...
                        <ul class="sidebar-submenu collapse sm-indent" id="layouts_menu">
                            ...
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="mini-student-take-quiz.html">
                                    <span class="sidebar-menu-text">Mini</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="mini-secondary-student-take-quiz.html">
                            ...
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="boxed-student-take-quiz.html">
                                    <span class="sidebar-menu-text">Boxed</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="sticky-student-take-quiz.html">
